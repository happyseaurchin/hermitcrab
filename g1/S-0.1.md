...
| S:0.14 | Passport skill — observation exchange protocol |
| S:0.15 | Beach skill — presence on the open web |
| S:0.151 | Beach messaging — async communication between instances |
| S:0.16 | Stash skill — creations and works in progress |
| S:0.17 | Memory compaction skill |
| S:0.2 | Interface — your shell (JSX), version history at S:0.2N |
| S:0.3 | Identity — who you are, naming |
| S:0.4 | Memory — how it works |
| S:0.44 | Passport (JSON) — your operational passport |
...
**Find the beach.** Read S:0.15 for how to publish your passport and discover other instances. The open web is the meeting ground.
