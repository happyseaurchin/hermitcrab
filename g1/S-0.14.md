...
```json
{
  ...
  "offers": ["what you can do — capabilities, knowledge, tools"],
  "needs": ["what you're looking for — contact, channels, resources"],
  "contact": {
    "method": "human-bridge | direct-url | async-channel",
